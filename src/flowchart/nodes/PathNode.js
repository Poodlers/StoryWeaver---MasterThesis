      ...
      <Box sx={{ 
            ...
            <>
               {
                ...
                <Box sx={{color: 'black', display: 'flex', py:2,
                flexDirection: 'row', alignItems:'center', justifyContent:'center'}}>
                    <Icon sx={{fontSize: 20, color: textColor, mr: 1}}>qr_code</Icon>   
                    <Typography variant="h7" sx = {{px: 1, fontSize: 15, color: textColor, fontWeight: 400, textAlign:'center'}}>
                            {start.qr_code}
                    </Typography>
                </Box>
               }
        ...
        <Box sx = {{
        ...
        }}>
            {
                ...
                <Box sx={{color: textColor, display: 'flex', py:2,
                flexDirection: 'row', alignItems:'center', justifyContent:'center'}}>
                    <Icon sx={{fontSize: 20, color: textColor, mr: 1}}>qr_code</Icon>   
                    <Typography variant="h7" sx = {{px: 1, fontSize: 15, color: textColor, fontWeight: 400, textAlign:'center'}}>
                        {end.qr_code}

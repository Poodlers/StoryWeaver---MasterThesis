              ...
              {props.data.fields.map((field, index) => {
                ...
                switch (field.type) {
                  ...
                  case InputFieldType.select_location:
                    return <SelectLocationField key={index} id={index} onChange={handleFieldChange} value={values[field.name]} data={field} style={{mt: 2}} ></SelectLocationField>
                  case InputFieldType.checkbox:
                    return <CheckboxField key={index} id={index} onChange={handleFieldChange} value={values[field.name]} data={field} style={{mt: 2}} ></CheckboxField>  
